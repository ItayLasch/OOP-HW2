...
class UserImplTest {
    ...
    void getFavoriteSongs() throws User.IllegalRateValue, User.SongAlreadyRated {
        ...
        Song s = new SongImpl(s5.getID(), s5.getName(), s5.getLength(), s5.getSingerName());
        assert (s != s5);
        assertEquals(s, s5);
    ...
    void favoriteSongInCommon()
            throws User.SamePerson, User.AlreadyFriends, User.IllegalRateValue, User.SongAlreadyRated {
